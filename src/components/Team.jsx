  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      {teamdata?.map((team)=>(
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" >
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" key={team.image} src={team.image} alt="Bonnie Avatar"/>
              </a>
              <div className="p-5">
                  ...
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{team.description}</p>
