                ...
                <div className="p-5">
                    ...
                    <li>
                      ...
                      >
                        ...
                        >
                          <path
                            fill-rule="evenodd"
                            d="M19 0h-14c-2.75 0-5 2.25-5 5v14c0 2.75 2.25 5 5 5h14c2.75 0 5-2.25 5-5v-14c0-2.75-2.25-5-5-5zm-11.75 20.5h-2.5v-9.25h2.5v9.25zm-1.25-10.5h-.02c-.82 0-1.33-.57-1.33-1.28 0-.73.54-1.28 1.37-1.28s1.33.55 1.35 1.28c0 .71-.51 1.28-1.37 1.28zm11.25 10.5h-2.5v-5c0-1.25-.44-2.09-1.55-2.09-.84 0-1.33.56-1.55 1.1-.08.2-.1.47-.1.75v5.25h-2.5v-9.25h2.5v1.25c.34-.52.95-1.25 2.3-1.25 1.68 0 2.95 1.09 2.95 3.43v5.82z"
                            clip-rule="evenodd"
                          />
                        </svg>
                      </a>
                  ...
                  {team.tasks.map((task) => (
                    <div className="mt-5 sm:block">
                      <h2 className="text-left text-green-500 font-bold md:text-center">
                        {" "}
                        Work in Progress
                      </h2>
                      <div className="flex justify-between">
                        <div className="flex items-center">
                          ...
                          <p className="text-medium text-gray-500">Feature</p>
                        </div>
                        <h2 href="#" className="text-blue-500">
                          Description
                        </h2>
                      </div>
