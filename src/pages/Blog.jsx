      ...
      contributions: [
        {
          ...
          items: [
            ...
            "Final Implementation Report Documentation: Actively participated in documenting the final report, including system implementation, user manual, performance evaluation, and test results.",
            "User Manual: Authored the draft of the User Manual (Appendix A), providing end-users with clear guidelines on system usage and troubleshooting.",
          ],
        },
        {
          ...
          items: [
            ...
            "Assisted in creating backend APIs and API referencing.",
            "API Testing, utilized tools like Postman to test the API endpoints during integration with the backend.",
            "Implemented the notification, forms and other system components.",
      ...
      contributions: [
        ...
        },
        {
          ...
          items: [
            ...
            "Developed the AI Agent using OpenAI and recommedations feature",
          ],
        },
      ],
    },
      ...
      contributions: [
        {
          ...
          items: [
            ...
            "Formulation of the SRS Document. He was involved in designing specifications and usecases",
            "SDD Documentation: Contributed to the development of the Software Design Document (SDD).",
            "Final Implementation Report Documentation: Participated in compiling the final implementation report, including system performance, user manual, and testing outcomes.",
          ],
        },
        {
          category: "System Development",
          items: [
            ...
            "Involved in the backend system development.",
          ],
        },
      ],
    },
